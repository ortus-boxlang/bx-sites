...
Seite zeigt durchgehend YAML-Schnipsel, passend zum Standardformat von
`bxSites new`, liest sich in JSON aber genauso.
...
Jede gerenderte Tabelle erhält außerdem automatisch einen Wrapper für responsives Scrollen und einen fixierten Kopfbereich, ohne eigenen Konfigurationsschlüssel - siehe [Tabellen](guides/markdown.md#responsives-scrollen-und-eine-fixierte-kopfzeile).
