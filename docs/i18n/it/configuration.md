...
pagina mostra solo snippet YAML, secondo il formato predefinito proprio di
`bxSites new`, ma ognuno di essi si legge allo stesso modo in JSON.
...
Ogni tabella renderizzata riceve anche automaticamente un wrapper per lo scroll responsive e un'intestazione fissa, senza una propria chiave di configurazione - vedi [Tabelle](guides/markdown.md#scorrimento-responsive-e-intestazione-fissa).
