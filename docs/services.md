...
description: Need help building, migrating, or maintaining a BxSites site? Ortus Solutions offers professional services and consulting for documentation sites and static sites of any kind.
tags: [services, consulting]
---

# Consulting & Professional Services

BxSites is free, open source, and built to be used without anyone's help -
...
also any other **static site**: BxSites is a general-purpose static site
...
designed, built, and deployed with BxSites from the ground up.
:::
...
tool entirely - over to BxSites, content and structure intact.
:::
...
BxSites doesn't cover out of the box.
:::
::: card title="Training & support" icon="phosphor-duotone:graduation-cap"
Get your team up to speed on BxSites, BoxLang, and the wider Ortus
...
Ortus Solutions builds and maintains BoxLang, BxSites, and the rest of the
BoxLang ecosystem - nobody knows this tooling better than the people who
wrote it. Professional services with us aren't limited to BxSites, either:
