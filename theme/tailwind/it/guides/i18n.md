...
scritta da destra a sinistra, la propria direzione) in `bxsites.yaml`:
...
[selettore di versione](../configuration.md#versionamento). Mostra la
...
Tre locale includono di serie una traduzione integrata: `de`, `es` e
`it`. Compilando uno di questi codici locale ottieni
...
=== "TOML"
    ...
    [i18n.locales.strings]
    toggleDarkMode = "Cambiar a modo nocturno"
    ```
...
sono le pagine [versionate](../configuration.md#versionamento).
