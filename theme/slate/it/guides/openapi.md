...
[Blocchi di contenuto](content-blocks.md). `src` viene risolto nello stesso modo,
...
descrivere a mano un singolo endpoint; importa sempre una specifica reale
al suo posto. Se non ne hai ancora una:
