...
BX Docs ist ein BoxLang-Modul, das statische Dokumentations-Websites aus
Markdown erzeugt, im Geiste von [mkdocs](https://www.mkdocs.org/) und
[mkdocs-material](https://squidfunk.github.io/mkdocs-material/).

Genau diese Seite wird von BX Docs gebaut, aus den Markdown-Dateien im
...
- **Markdown wird von [bx-markdown](https://github.com/ortus-boxlang/bx-markdown) verarbeitet.**
  BX Docs parst Markdown nicht selbst; es delegiert an bx-markdown und
  reicht deine eigenen `bxdocs.json`-Optionen direkt daran weiter.
...
- [Konfiguration](configuration.md) - die vollständige `bxdocs.json`-Referenz
