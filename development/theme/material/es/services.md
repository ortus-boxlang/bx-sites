...
summary: ¿Necesitas ayuda para construir, migrar o mantener un sitio con BxSites? Ortus Solutions ofrece servicios profesionales y consultoría para sitios de documentación y sitios estáticos de cualquier tipo.
description: ¿Necesitas ayuda para construir, migrar o mantener un sitio con BxSites? Ortus Solutions ofrece servicios profesionales y consultoría para sitios de documentación y sitios estáticos de cualquier tipo.
tags: [servicios, consultoría]
---

# Consultoría y Servicios Profesionales

BxSites es gratuito, de código abierto, y está construido para usarse
...
BxSites es un generador de sitios estáticos de propósito general, no
...
otro sitio estático - diseñado, construido y desplegado con BxSites
desde cero.
:::
...
herramienta de documentación/sitios estáticos - a BxSites, con su
...
BoxLang para un flujo de trabajo que BxSites no cubre de fábrica.
:::
::: card title="Formación y soporte" icon="phosphor-duotone:graduation-cap"
Pon a tu equipo al día con BxSites, BoxLang y el resto del ecosistema
...
Ortus Solutions construye y mantiene BoxLang, BxSites y el resto del
...
limitan a BxSites: consulta la gama completa, desde aumento de personal
