...
BX Docs は[セマンティックバージョニング](https://semver.org/)に従っています。
...
- **`main`** は安定版ブランチです。そこへのプッシュが本番のタグ付きリリースを作成します:
  プロジェクト独自の [`changelog.md`](https://github.com/ortus-boxlang/bx-docs/blob/main/changelog.md)
...
同じ注記は[GitHub リリース](https://github.com/ortus-boxlang/bx-docs/releases)にも添付されます。
