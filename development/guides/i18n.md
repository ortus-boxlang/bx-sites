...
Once more than one locale exists, every theme renders a language dropdown
in the header automatically - nothing to opt into, same as the
[version switcher](../configuration.md#versioning). Pick a locale you're
not currently building and it simply won't render at all.
